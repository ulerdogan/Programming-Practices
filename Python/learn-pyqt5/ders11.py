...
class Menu(QMainWindow):
    ...
    def __init__(self):
        ...
        dosya_ac.setShortcut("Ctrl+O") #kısayol ekleme
        ...
        ara_ve_degistir = duzenle.addMenu("Ara ve Değiştir") #menü altına başka menü ekleme
        ...
        cikis.triggered.connect(self.cikis_yap) #bastığında çalıştırılacak fonksion
    ...
    def cikis_yap(self):
        qApp.quit()
    def response(self,action): #python kendi action gönderiyor
