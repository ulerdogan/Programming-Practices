...
class Pencere(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.baglanti_olustur() #database bağlamak için fonk
        self.init_ui()

    def baglanti_olustur(self):
        baglanti = sqlite3.connect("database_k_g.db")
    ...
    def init_ui(self):
        ...
        self.parola.setEchoMode(QtWidgets.QLineEdit.Password) # şifre moduna geçirr
